...
local siriusSettings = {
	{
		name = 'General',
		description = 'The general settings for SenzX, from simple to unique features.',
		color = Color3.new(0.117647, 0.490196, 0.72549),
		minimumLicense = 'Free',
		categorySettings = {
			{
				name = 'Anonymous Client',
				description = 'Randomise your username in real-time in any CoreGui parented interface, including SenzX. You will still appear as your actual name to others in-game. This setting can be performance intensive.',
				settingType = 'Boolean',
				current = false,
			...
			{
				name = 'Chat Spy',
				description = 'This will only work on the legacy Roblox chat system. SenzX will display whispers usually hidden from you in the chat box.',
				settingType = 'Boolean',
				current = true,
			...
			},
			{
				...
				description = 'When active, SenzX will notify you when the next song in your Music queue plays.',
				settingType = 'Boolean',
				current = true,
	...
	{
		name = 'Keybinds',
		description = 'Assign keybinds to actions or change keybinds such as the one to open/close SenzX 💀.',
	...
	{
		name = 'Performance',
		description = 'Tweak and test your performance settings for Roblox in SenzX.',
		color = Color3.new(1, 0.376471, 0.168627),
		minimumLicense = 'Free',
		categorySettings = {
			{
				name = 'Artificial FPS Limit',
				description = 'SenzX will automatically set your FPS to this number when you are tabbed-in to Roblox.',
				settingType = 'Number',
				values = {20, 5000},
				current = 240,
			...
			},
			{
				...
				description = 'SenzX will automatically set your FPS to 60 when you tab-out or unfocus from Roblox.',
			...
			},
			{
				...
				description = 'SenzX will check your average latency in the background and notify you if your current latency significantly goes above your average latency.',
				settingType = 'Boolean',
				current = true,
			...
			},
			{
				...
				description = 'SenzX will check your average FPS in the background and notify you if your current FPS goes below a specific number.',
				settingType = 'Boolean',
				current = true,
	...
	{
		name = 'Detections',
		description = 'SenzX detects and prevents anything malicious or possibly harmful to your wellbeing.',
		...
		categorySettings = {
			...
			},
			{
				...
				description = 'Be notified whenever SenzX detects a player joins your session that could be a game moderator.',
				settingType = 'Boolean', 
				minimumLicense = 'Pro',
				current = true,
